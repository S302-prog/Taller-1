...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar pais del atleta a partir de su nombre");
	...
	{
		String nombre = input("Por favor ingrese el nombre del atleta que desea consultar");
		String respuesta = calculadora.atletaPais(nombre);
		System.out.print("El atleta " + nombre + " es de nacionalidad " + respuesta);
	}
